...
<form action="../../functions/process-forms.php" method="post" enctype="multipart/form-data">
	...
	<div class="advertisement-info">
		...
		<input type="text" name="title" placeholder="Title of The Advertisement" required>
		...
		<input type="submit" name="sell-post" value="Post it">
	...
	<div class="auction-time">
		...
		<section>
			...
			<input type="text" name="start-date" id="start-datepicker" placeholder="Starting Date" required>
		</section>
		...
		<section>
			...
			<input type="text" name="end-date" id="end-datepicker" placeholder="End Date" required>
		</section>
		...
		<section>
			...
			<input type="text" name="start-price" placeholder="Starting Price" required>
		</section>
	...
	<div class="upload-modal">
		...
		<div class="modal-content">
			...
			<div class="modal-images">
				<img src="../../images/others/placeholder_product.jpg" alt="Thumbnail">
				<input type="file" name="img1" class="input-image">
			</div>

			<div class="modal-images">
				<img src="../../images/others/placeholder_product.jpg" alt="Thumbnail">
				<input type="file" name="img2" class="input-image">
			</div>

			<div class="modal-images">
				<img src="../../images/others/placeholder_product.jpg" alt="Thumbnail">
				<input type="file" name="img3" class="input-image">
			</div>

			<div class="modal-images">
				<img src="../../images/others/placeholder_product.jpg" alt="Thumbnail">
				<input type="file" name="img4" class="input-image">
			</div>
